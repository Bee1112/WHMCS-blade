...
<html lang="en" data-theme="light">
  ...
  <section class="home-hero login">
    ...
    <div class="badge reset-success">
      <img src="{{asset('assets/img/reset-success.svg')}}" alt=""> Send reset instructions was succesful.
    </div>
      ...
      <div class="mt-5 text-center login-card-wrapper">
          ...
          <div class="card-item login-card">
              ...
              <form action="route('login')" method="POST">
                ...
                <button class="btn-light w-100 mb-3" onClick="{{URL::to('/login/signup')}}">Register account</button>
